#!/usr/Haroon/python2
#coding=utf-8
#The Credit For This Code Goes To Haroon
...
\033[1;95m
\033[1;95m
\033[1;92m•◈•-----------------•◈•\033[1;97mHaroono\033[1;91m•◈•------------•◈•"""
jalan("\033[1;91m╭━━━━━━━╮")
jalan("\033[1;91m┃       ● ══    ┃")
jalan("\033[1;91m┃███████┃")
jalan("\033[1;91m┃███████┃")
...
jalan("\033[1;91m┃         ○        ┃")
jalan("\033[1;91m╰━━━━━━━╯")
jalan("\033[1;94m----------------T00L UPDATE DONE BY Haroono-------")
print "\033[1;95m-----------\033[1;93mHaroon Ahmad-------------"

CorrectUsername = "Haroon"
CorrectPassword = "Swabi"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:M Haroon
	    time.sleep(2)
            loop = 'false'
        else:
...
def pilih_super():
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;97m----------------\033[1;95mHaroon\033[1;97m-------------------"
	print "  \033[1;93m-------Creadit to me [Haroon]--------" #Dev:Haroon
	print '\033[1;94mProcess Has Been Completed Press->Ctrl+Z[<-πNext Type (python2 Haroono.py)↩\033[1;97m....'
...
╩╩╩╩╩╩▀▄▄▄▄▄▄▀╩╩╩╩╩╩
         ...
         Checkpoint ID Open After 3 Days(1/2Week)
